...
process mega_treeMod{
    ...
    apptainer  exec docker://pegi3s/megax_cc:latest megacc -a ${params.mao4tree} -d ${params.output}/${xp}/mega_out/mega_aln/EV_vp1_aln.meg -o ${params.output}/${xp}/mega_out/mega_tree
