...
include { FASTQC as FASTQC_ev } from './gentypuds_modules/ev_gen_fastqc.nf'
include { trimmomatic as trimmomatic_ev } from './gentypuds_modules/ev_trim.nf'
include { bbtools as bbtools_ev } from './gentypuds_modules/ev_bbtools.nf' 
include {scrub as scrub_ev } from './gentypuds_modules/ev_scrub.nf'
...
include {pilon} from './gentypuds_modules/ev_pilon_cons.nf'
include {quast} from './gentypuds_modules/ev_quast.nf' // added on 04/23
include {pyAsbProc} from './gentypuds_modules/ev_py1AssProc.nf' // added on 04/23
include {readsproc} from './gentypuds_modules/ev_readsproc.nf' // added on 04/23
include {multiqc} from './gentypuds_modules/ev_multqc.nf' //added on 04/23
include {readstat} from './gentypuds_modules/ev_py2readStat.nf'
include {krakenproc} from './gentypuds_modules/ev_py3Krakenproc.nf'
include {reportproc} from './gentypuds_modules/ev_py4ReportProc.nf' //commented on 08/30/2024
include {unmapped_proc} from './gentypuds_modules/ev_unmapped.nf'
include {fast_ani1} from './gentypuds_modules/ev_fastANIni.nf'
include {copy_files} from './gentypuds_modules/ev_copy.nf' // added on 01/15/2025
include {rem_descr} from './gentypuds_modules/ev_removeDescript.nf' // moved on 02/25/25
include {clustalo} from './gentypuds_modules/ev_clustalo.nf'
include {iqtree} from './gentypuds_modules/ev_iqtree.nf'
include {dna2protein_proc} from './gentypuds_modules/ev_dna2protein2.nf'
include {blast_nucl} from './gentypuds_modules/ev_blast_n.nf'
include {blast_prot} from './gentypuds_modules/ev_blast_p.nf'
include {treeAnnotProc} from './gentypuds_modules/ev_phytree_annot2.nf'
include {clustalo_vp1 } from './gentypuds_modules/ev_clustalovp1.nf'
include {iqtree_vp1 } from './gentypuds_modules/ev_iqtree_vp1.nf'
include {treeVP1Annot} from './gentypuds_modules/ev_phytree_VP1annot.nf'
include {mega_aln} from './gentypuds_modules/ev_mega_aln.nf'
include {mega_treeMod} from './gentypuds_modules/ev_mega_tree.nf'
include {kraken4gtype} from './gentypuds_modules/ev_kraken_types.nf'
include {kraken_gtypeproc} from './gentypuds_modules/ev_py6krakenTypeproc.nf'
// Reuse Process
include {treeAnnotTemp} from './gentypuds_modules/ev_treeAnnot_mod12.nf'
